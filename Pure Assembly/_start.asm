...
; //  Author Section: Section 1
; //
; //Program information
; //  Program name: Triangle
; //  Programming languages: one module in X86, one module in C
; //  Date program began: 2022 October 10
; //  Date of last update: 2022 October 29
; //  Date of reorganization of comments: 2022 October 29
...
tab db 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0    ;Declare an array of 8 bytes where each byte is initialize with 32 (blank space).  Thus, this array equals 
                                                            ;one standard tab.
welcome db "Welcome to Accurate Cosines by Shawn Melwani.", 10, 0
